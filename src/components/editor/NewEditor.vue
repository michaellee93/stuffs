<template>
	<div class="block">
		<icon-tray @click="active = true" v-show="active" @format="bold" :link-active="linkActive" :bold-active="boldActive"
			:italic-active="italicActive" :show-delete="showDelete" @delete="deleteBlock" />
